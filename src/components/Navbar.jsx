    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto '>
        <Link to="/"
              ...
              <p className='text-white text-[18px] font-bold cursor-pointer flex sm:flex-none'> Alejandro Marin &nbsp; <span className='sm:block hidden'>| Full Stack Developer</span> </p>
        </Link>
